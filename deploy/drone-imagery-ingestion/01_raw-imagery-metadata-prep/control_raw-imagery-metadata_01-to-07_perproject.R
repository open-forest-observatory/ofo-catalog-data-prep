...
cat("\n\n****Starting script 5b****\n\n")
source(file.path(repo_root,"deploy/drone-imagery-ingestion/01_raw-imagery-metadata-prep/05b_find-duplicate-images.R"))
cat("\n\n****Starting script 5c****\n\n")
source(file.path(repo_root,"deploy/drone-imagery-ingestion/01_raw-imagery-metadata-prep/05c_remove-duplicate-images.R"))
cat("\n\n****Starting script 6****\n\n")
