...
mission_id_foc = "001420"

# Destination folder:
zip_filepath = file.path(
  DOWNLOADED_IMAGERY_ZIP_DIR,
...
# !!!! Make sure remote file exists using iquest
...
# and more robust because it's not restricted to 10 simultaneous connections)
...
command = paste("unzip", shQuote(zip_filepath), "-d", shQuote(unzip_dir))
