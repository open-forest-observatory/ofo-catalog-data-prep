# Purpose: Estimate DBH for each detected tree using cloud2trees, compute per-composite summary
# statistics (tree density, basal area, large tree density, proportion pine), add as attributes to
# the composite drone plot summaries GPKG, and produce heatmap rasters for pine proportion and large
# tree density.
...
# TODO: Use cloud2trees package to estimate DBH from tree height.
# The function and allometry equation to use need to be determined.
